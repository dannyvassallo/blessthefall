...
```shell
git clone https://github.com/dannyvassallo/blessthefall.git
cd blessthefall
```

From the "blessthefall" directory, install the gems by running the following:
```shell
bundle install
```

To fire up the server while in the "blessthefall" directory use this command:
```shell
middleman s
```
...
pwd
```
It should turn up "blessthefall"
